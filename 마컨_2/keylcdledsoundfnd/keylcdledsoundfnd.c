...
//
char str1[]= "  Electric piano   ";
char str2[]= "       for baby";
char str3[]= " song: airplane ";
//
...
int main(void){
	...
	int i;
	DDRE=0xFF; DDRF=0x0F;
    TCCR0=0xDC; OCR0=35;  TIMSK=0x02;  //16000000/  64/(1+249)= 1000Hz=1ms
    SREG=0x80;
    old=KeyScan();
    lcd_init();
